...
void show_error()
{
gotoxy(50,43);cputs("! ! !    WRONG OPTION    ! ! !");
}
	 ...
	 void TRAVELS::book_TRAVELS()
{
 ...
 do
 {
   ...
   textcolor(2);
   frm=take_correct_input("ENTER CITY CODE    :  ",50,47);
 ...
 do
 {
   ...
   view_city(frm);
   textcolor(2);
   to=take_correct_input("ENTER CITY CODE    :  ",50,47);
  ...
  do
  {
   ...
   textcolor(4);
   gotoxy(52,43);cputs("TOUR COST IS    :   Rs  ");cout<<trvl.amount;
   ...
   Info_popUp("!!   BOOIKING  SUCCESSFULL   !!","PLEASE  REMEMBER  YOUR  ID","YOUR  ID  Is  - ",trvl.travel_id);
    ...
    void TRAVELS::view_book(int check)
{
 textcolor(3);
 int i;
 for(i=14;i<42;i++){ gotoxy(31,i);putch(178); }
 for(i=14;i<42;i++){ gotoxy(101,i);putch(178); }

 gotoxy(32,14);for(i=0;i<69;i++) putch(220);
 ...
 gotoxy(32,41);for(i=0;i<69;i++) putch(220);
	...
	void main()
{
	 ...
	 for(int i=23,j=106;i<107;i++,j--)
   {
	...
	{	gotoxy(23,j); putch(177); gotoxy(106,i); putch(177);  Sleep(20);}
   Sleep(300);
	...
	void change_pass()
{
  ...
  if(!strcmp(PAS,passwrd))
  {
   ...
   gotoxy(47,20);cputs("ENTER A NEW PASSWORD ");
   titlebox("*  *   CHANGE MY PASSWORD   *  *");
