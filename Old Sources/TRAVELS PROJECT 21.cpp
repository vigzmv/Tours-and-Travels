...

{
   ...
   for(i=12;i<39;i++){ gotoxy(31,i);putch(178); }
	for(i=12;i<39;i++){ gotoxy(100,i);putch(178); }
...
gotoxy(53,35);putch(224);putch(224);cout<<"      Rs. "<<amount; gotoxy(80,32);putch(224);putch(224);
  ...
  void admin_tour::view_tour(int j)
  {
   ...
   gotoxy(57,((j*14)+46));cputs("ENTER = SELECT");
	 ...
	 do
    {
      ...
      if(mod==adm.tour_no)
{
   gotoxy(50,12);textcolor(2);cputs("*  *  ENTER NEW RECORDS   *  *");
   ...
   gotoxy(22,24);textcolor(3);cputs("TOUR No.   ");cout<<"\t\t:\t\t";cout<<adm.tour_no;
...
textcolor(2);
gotoxy(44,20);cputs("CUSTOMER NAME             :");gotoxy(78,20);puts(cust_name);
gotoxy(44,21);cputs("CUSTOMER PHONE            :");gotoxy(78,21);cout<<cust_phone;
gotoxy(44,22);cputs("CUSTOMER EMAIL            :");gotoxy(78,22);puts(cust_email);
...
gotoxy(49,40);cputs("Rs. : ");No_coverter_caller(totamount);cout<<" - ONLY ";
...
void cust_tour::book_tour()
         ...
         if(!temp)
   {
     ...
     customer();
         ...
         gotoxy(43,26);cputs(" ENTER YOUR PHONE    :     ");
         cin>>cust_phone;
         ...
         {
         gotoxy(76,21);cout<<"\t\t\t";
         gotoxy(45,21);cputs("ENTER DATE                 :     ");
         cin>>cust.cDay.dd;
         }while(!((cust.cDay.dd>=1)&&(cust.cDay.dd<=31)));

         gotoxy(42,27);cputs("PLEASE ENTER NO. OF TICKEST REQUIRED  :  ");
         cin>>cust.no_seats;
         ...
         if(user_confirmation("DO YOU WANT TO BOOK THIS  ?")) admin();
         ...
         t.open("TOUR_PACKAGES.dat",ios::binary|ios::in);
        		...
        		if(tm==adm.tour_no)
          {
            ...
            //textcolor(4);
            //gotoxy(46,33);cputs("  THE TICKET COST IS  -  Rs ");
         	//cout<<cust.totamount;
         	getch();
          }
			}
