...
TRAVELS trvl;
   ...
   gotoxy(54,18);cout<<"<>  View Tour Bookings ";
   gotoxy(54,21);cout<<"<>  View Travels Bookings ";
   gotoxy(54,24);cout<<"<>  Create Tour Packages";
   gotoxy(54,27);cout<<"<>  View Tour Packages ";
   gotoxy(54,30);cout<<"<>  Modify Tour Packages ";
   gotoxy(54,33);cout<<"<>  Delete Tour Packages ";
   gotoxy(54,36);cout<<"<>  Change Password ";
...
fstream file;
   ...
   gotoxy(54,23);cout<<"<>  BOOK MY TRAVELS ";
   gotoxy(54,26);cout<<"<>  CANCEL MY TOUR BOOKINGS ";
   gotoxy(54,29);cout<<"<>  CANCEL My TRAVEL BOOKINGS ";
   gotoxy(54,32);cout<<"<>  OFFER OF THE DAY !!";
