...
/* ------------------------------------------------------*/
 ...
 void menu();    							//Menu for the selection account.
 void pass();    							//Interface to take password
 void admin();   							//Menu for admin
 void customer(); 						//Menu fo Customer
 void Mv_logo();   						//Introductory Logo
 void change_pass(); 					//For changing password

 void output_box_date_n_time();        	  //Default Design
 void titlebox(char title[],int a,int b);   //Title and time
 void show_error();								  //Error reporter

 void No_converter(long,char[]);            //numeric convertor
 void No_coverter_caller(int n);            //numeric convertor
 ...
 void lock(int valcheck);                   //Lock Design
 void authentication_wait(int sec);         //Screen Freeze

 void CursorControl(int T_F);            //Cursor Controler
 ...
 __int64 take_correct_input(char out[],int x,int y);
	...
	void output_box_date_n_time()
{
   ...
   for(int i=3;i<8;i++)
 	{
    gotoxy(5,i); putch(186);
    gotoxy(126,i); putch(186);
   }
...
{
   //x,y are default coordiantates of the cursor
	...
	void Info_popUp(char TITLE[],char subTITLE[]="\0",char sub2TITLE[]="\0",int Var=0)
{
   ...
   int len=strlen(TITLE);          //Main Title
    ...
    class admin_pass
{
   ...
   private : char pass[10];
    ...
    admin_pass()    //Constructor
   {
   	strcpy(pass,"tour");   //Default Password
   }
	...
	class TRAVELS
{
   ...
   char mode_travel[20],email[30];
   char cust_name[30],from[30],dest[30];
   long int amount; int no_tickets;
	__int64 cust_phone;
   tdate cDay;
	 ...
	 void TRAVELS::book_TRAVELS()
{
 ...
 do
 {
   ...
   gotoxy(48,13);cputs("*  *  SELECT YOOR PICKUP CITY   *  *");

   view_city(69);

   textcolor(2);
   frm=take_correct_input("ENTER CITY CODE    :  ",51,44);
 ...
 do
 {
   clrscr();
   textcolor(2);
   gotoxy(48,13);cputs("*  *  SELECT YOUR DESTINATION CITY   *  *");

   view_city(frm);
   textcolor(2);
   to=take_correct_input("ENTER CITY CODE    :  ",51,44);
  ...
  textcolor(2);
  trvl.no_tickets=take_correct_input("ENTER NO. OF TICKEST REQUIRED      :     ",45,28);
  ...
  do
  {
   ...
   randomize();
   trvl.amount=(((random(7)+2)*100+random(5)*10)*trvl.no_tickets);
   trvl.travel_id=give_id(3);

   textcolor(4);
   gotoxy(51,44);cputs("TRAVEL COST IS    :   Rs.  ");cout<<trvl.amount;
   ...
   Info_popUp("!!   BOOKING  SUCCESSFUL   !!","PLEASE  REMEMBER  YOUR  ID","BOOKING  ID  Is  - ",trvl.travel_id);
   ...
   getch();
   if(user_confirmation("Do You Want To PRINT This ?")) customer();
    ...
    void TRAVELS::cancel_travel(int WHOcalls)
{
 ...
 textcolor(2);
  ...
  titlebox("*  *   MY TRAVEL  BOOKING   *  *",79,17);
   ...
   while(!oldf.eof())
{
   ...
   if(id==trvl.travel_id)
 {
  ...
  {
   loading("!!    SENDING  REQUEST    !!","PLEASE WAIT");
   Info_popUp("!!   CANCELLATION  SUCCESSFUL   !!","BOOKING  HAS  BEEN  CANCELLED","YOUR  ID  was  - ",id);
   getch();
  }
	...
	void TRAVELS::view_city(int frm)
{
 ...
 {
   if(frm==(i+7)) continue;
   gotoxy(76,(i*4)+20);cout<<(i+7)<<".  ";cputs(city_list[i+6]);
 }
   textcolor(2);

   gotoxy(51,44);cputs("ENTER CITY CODE    :  ");
		...
		void admin_tour::entry()
{
 ...
 textcolor(2);
  gotoxy(38,20);cputs("Enter Tour  NAME                :        ");
  titlebox("* *  TOUR ENRTY  * *",79,20);
 textcolor(2);
  gotoxy(38,20);cputs("Enter Tour  NAME                :        ");
  gets(adm.tourname);
  gotoxy(38,23);cputs("Enter Tour  CITY                :        ");
  gets(adm.city);
  gotoxy(38,26);cputs("Enter Tour  PLACES              :        ");
  gets(adm.place);
  gotoxy(38,29);cputs("Enter Tour  DETAILS             :        ");
  gets(adm.details);
  gotoxy(38,32);cputs("Enter Tour  DAYS                :        ");
  gets(adm.day);
  adm.tariff=take_correct_input("Enter Tour  FARE                 :       ",38,35);
   ...
   void admin_tour::modify_tour()
{
  ...
  textcolor(5);
   gotoxy(22,24);     cputs("TOUR No.   ");
   cout<<"\t:\t\t";    cout<<adm.tour_no;

   gotoxy(22,27);     cputs("TOUR NAME ");
   cout<<"\t\t:\t\t";  puts(adm.tourname);

   gotoxy(22,30);     cputs("TOUR CITY ");
   cout<<"\t\t:\t\t";  puts(adm.city);

	gotoxy(22,33);     cputs("PLACES    ");
   cout<<"\t\t:\t\t";  puts(adm.place);

   gotoxy(22,36);     cputs("DETAILS   ");
   cout<<"\t\t:\t\t";  puts(adm.details);

   gotoxy(22,39);     cputs("TOUR DAYS ");
   cout<<"\t\t:\t\t";  puts(adm.day);

   gotoxy(22,42);     cputs("TOUR FARE ");
   cout<<"\t\t:\t\t";  cout<<adm.tariff;
            ...
            if(opt1==13)
         {
             if(y==27)
                ...
                gets(adm.day);
              	...
              	{
                adm.tariff=take_correct_input("",89,42);
               }
        else if(y==45)
               {
         ...
         else
            {
    		     ...
    		     Info_popUp("!!    MODIFICATION  SUCCESSFUL    !!","PACKAGE MODIFIED","MODIFIED  PACKAGE  Id - ",mod);
     			  loopend=1;
				}
     }
  ...
  void admin_tour::remove_tour()
{
  ...
  Info_popUp("!!    DELETION  SUCCESSFUL    !!","PACKAGE  DELETED ","DELETED  PACKAGE  Id ",rm);
	...
	void cust_tour::book_tour()
{
  ...
  textcolor(2);
   gotoxy(43,33);cputs(" PLEASE SELECT TOUR PACKAGE.....");
   getch();
   ...
   void cust_tour::view_book(int iscust)
{
 ...
 textcolor(5);
  gotoxy(53,36);
  putch(224); putch(224); cputs("      TOTAL AMOUNT :      ");putch(224);putch(224);
  gotoxy(53,37);
  putch(224); putch(224); cputs("       Rs. "); cout<<totamount; gotoxy(81,37); putch(224);putch(224);
   ...
   void cust_tour::cancel_tour(int Whocalls)
{
 ...
 if(!oldf)
 {
  ...
  titlebox("*  *   MY TOUR BOOKING  *  * ",79,17);
	...
	void main()
{
   ...
   for(int i=14;i>7;i--)
   {
   	...
   	if(i==8) textcolor(12);
    gotoxy(34,12);cputs("#     #    ####    #        ####     ####     #     #    #### ");Sleep(30);
	 gotoxy(34,13);cputs("#     #    #       #       #        #    #    # # # #    #    ");Sleep(30);
	 gotoxy(34,14);cputs("#  #  #    ####    #       #        #    #    #  #  #    #### ");Sleep(30);
	 gotoxy(34,15);cputs("# # # #    #       #       #        #    #    #     #    #    ");Sleep(30);
	 gotoxy(34,16);cputs("#     #    ####    #####    ####     ####     #     #    #### ");Sleep(30);
   }
	...
	void change_pass()
{
  ...
  if(!strcmp(PAS,passwrd))
  {
   ...
   textcolor(4);
   gotoxy(51,20);cputs("ENTER A NEW PASSWORD ");
   titlebox("*  *   CHANGE MY PASSWORD   *  *",51,22);
   ...
   textcolor(4);
   gotoxy(51,24);cputs("ENTER THE PASSWORD AGAIN");
