...
void loading(char TITLE[],char subTITLE[])
{
  ...
  textbackground(1);
   ...
   for(int i=17;i<32;i++)
   				{
               	gotoxy(45,i);putch(186); 	gotoxy(89,i);putch(186);
               }
   gotoxy(45,32);putch(200);
   				for(int i=0;i<43;i++)
   				{
               	putch(205);
               }
   ...
   gotoxy(46+((44-len)/2),20);cputs(TITLE);
   gotoxy(46+((44-len2)/2),25);cputs(subTITLE);


   gotoxy(53,28);putch(220);
   				for(int i=0;i<27;i++)
   				{
               	putch(220);
               }
  	...
  	gotoxy(53,29);putch(219); 	gotoxy(81,29);putch(219);


   gotoxy(53,30);putch(223);
   				for(int i=0;i<27;i++)
   				{
               	putch(223);
               }
    ...
    gotoxy(56,29);textbackground(4);cputs("                         ");
  ...
  while(loop-->0)
  {
   ...
   if(l>8)
   {
   gotoxy(l+45,29);textbackground(4);cputs(" ");
   }
   textbackground(1);

   gotoxy(46+((44-len2)/2)+(len2+i++),25);cputs(".");
   if(i==5) {
   gotoxy(46+((44-len2)/2)+len2,25);cputs("      ");

   i=0;
   }
   if(l<28)
   {
   gotoxy(53+l,29);textbackground(2);cputs(" ");
   }
   Sleep(50);
  	}
   textbackground(4);
...
int user_confirmation(char TITLE[],char subTITLE[]="\0")
{
   ...
   gotoxy(46+((44-len)/2),20);cputs(TITLE);
   gotoxy(45+((44-len2)/2),24);cputs(subTITLE);
...
char opt1,opt2;
   ...
   textbackground(5);
   gotoxy(58,25);cputs("                  ");
   gotoxy(58,26);cputs("     CONTINUE     ");
   gotoxy(58,27);cputs("                  ");
	textbackground(4);
   gotoxy(58,29);cputs("                  ");
   gotoxy(58,30);cputs("      CANCEL      ");
   gotoxy(58,31);cputs("                  ");
