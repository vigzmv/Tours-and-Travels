...
gotoxy(42,4); cout<<" TOURS AND TRAVELS SYSTEM ";
gotoxy(51,5);  //title

gotoxy(10,7);  cout<<" DATE  :  "<<day<<"/"<<mon<<"/"<<year;
gotoxy(79,7); cout<<" TIME  :  "<<hour<<":"<<min;
...
travels trvl;
   ...
   gotoxy(27,4);cout<<"  * *   ADMINISTRATOR  MENU   * *";
   gotoxy(29,11);cout<<"<> VIEW TOUR BOOKINGS ";
   gotoxy(29,13);cout<<"<> VIEW TRAVEL BOOKINGS ";
   gotoxy(29,15);cout<<"<> CREATE NEW TOUR PACKAGES";
   gotoxy(29,17);cout<<"<> VIEW TOUR PACKAGES ";
   gotoxy(29,19);cout<<"<> DELETE TOUR PACKAGES ";
   gotoxy(29,22);cout<<"<> CHANGE PASSWORD ";
   gotoxy(13,26);cout<<"( USE UP AND DOWN ARROW TO SELECT AND PRESS ENTER )";
   gotoxy(27,28);cout<<"( * * PRESS Esc TO GO BACK * *)";
...
clrscr();
   ...
   else if(opt1==0)
 {
      ...
      opt2=op2;
		switch(opt2)
       {
        	case 72: do
                ...
                {
                gotoxy(30,23);cout<<"!!!  WRONG OPTION   !!!";
					 }
         ...
         case 80 : do
            ...
            break;
  		default: gotoxy(30,23);cout<<"!!!  WRONG OPTION   !!!";
  ...
  gotoxy(28,20);cout<<"!!!  WRONG OPTION   !!!";
   menu();
      }
