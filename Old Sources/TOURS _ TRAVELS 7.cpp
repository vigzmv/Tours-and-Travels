	 ...
	 void TRAVELS::book_TRAVELS()
{
 ...
 do
 {
  ...
  do
  {
   ...
   randomize();
   trvl.amount=(((random(7)+4)*200+random(5)*10)*trvl.no_tickets);
	...
	void main()
{
   ...
   for(int i=14;i>7;i--)
   {
   	...
   	if(i==8) textcolor(12);
    gotoxy(34,12);cputs("#     #    ####    #        ####     ####     #     #    #### ");Sleep(60);
	 gotoxy(34,13);cputs("#     #    #       #       #        #    #    # # # #    #    ");Sleep(60);
	 gotoxy(34,14);cputs("#  #  #    ####    #       #        #    #    #  #  #    #### ");Sleep(60);
	 gotoxy(34,15);cputs("# # # #    #       #       #        #    #    #     #    #    ");Sleep(60);
	 gotoxy(34,16);cputs("#     #    ####    #####    ####     ####     #     #    #### ");Sleep(60);
   }
    textcolor(15);
     gotoxy(23,26);
